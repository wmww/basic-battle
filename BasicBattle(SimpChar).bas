...
20 filename$ = "BasicBattle(SimpChar).bas"
30 typspd=30
40 debug = 0
45 dirnums = 1
50 print "starting..."
...
340 dim rndm(100)
350 print
360 print "the following error may be due to to file name of the program being changed. rename the program to 'BasicBattle(SimpChar).bas' or change the second line of the program to the current file name (make sure to include the file exstension)."
