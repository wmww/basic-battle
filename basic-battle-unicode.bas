10 rem 0Tn./Z)]_;zi}m={2jeQ%JMUB[5x`Au@k$\?I9|<a(Ht>EW1,~3glGq&!Kbf'Xd+cL^yVYSC4v*:hO#F6woNsrD"8-P7Rp
...
150 ttl$ = "Williams basic battle 2.4 unicode version"
160 typ$ = ttl$
170 cls
180 goto 280
...
1110 if p2x = j and p2y = i and debug = 1 then pxl$ = "⌖"' player 2 (debug only)
1120 print pxl$;
1130 print "  ";
1140 next j
1150 print i
